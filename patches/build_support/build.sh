...
if [ "$PYTHON_VERSION" = "3" ]; then
  ...
  PYTHON_ARGS="$PYTHON_ARGS -Dpython_version=2 -DBOOST_LIBRARYDIR=$CONDA_DIR/lib/ -DPYTHON_EXECUTABLE=$CONDA_DIR/bin/python -DPYTHON_INCLUDE_DIR=$CONDA_DIR/include/ -DPYTHON_LIBRARY=$CONDA_DIR/lib/libpython2.7.so"
fi
if $WITH_IO; then
